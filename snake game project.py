...
pfont = pygame.font.SysFont('Baskerville Old Face', 35)
pSurf = pfont.render('Welcome to Snake Game created by Abinaya.', True, black)# add your name here
...
# Game over function
def gameOver():
    gFont = pygame.font.SysFont('Bradley Hand ITC', 82)
...
def showScore(choice=1):
    sFont = pygame.font.SysFont('Baskerville Old Face', 24)
    sfFont = pygame.font.SysFont('Baskerville Old Face', 42)
